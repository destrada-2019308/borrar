...
export const NavbarAdmin = () => {
    ...
    return (
        <StyledNavbar>
            <ul className='navbar'>
                <li onClick={() => goToPage('/home/zaru/admin/home')} className='logo-container'>
                    <a> <img src={logo} alt="Logo" width={50} /> </a>
                </li>
                <li onClick={() => goToPage('/home/zaru/admin/hotels')} className='ocultarElementos'>
                    <a href="#">Hotels</a>
                </li>
                <li onClick={() => goToPage('/home/zaru/admin/categoriesH')} className='ocultarElementos'>
                    <a href="#">Categorias hotel</a>
                </li>
                <li onClick={() => goToPage('/home/zaru/admin/users')} className='ocultarElementos'>
                    <a href="#">Users</a>
                </li>
                <li  className='perfil' onClick={toggleProfileDropdown} >
                    ...
                    <ul className={`perfil-dropdown ${profileDropdownVisible ? 'visible' : ''}`}>
                        <li onClick={() => goToPage('/home/zaru/admin/profile')}><a href="#">Profile</a></li>
